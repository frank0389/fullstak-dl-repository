           ...
           <table
             ...
             <thead
               ...
               <tr>
                {
                      headers.map( header =>{
                       return  <th scope="col" className=" px-6 py-4" key={header}>{header}</th>
                      })
                }
                <th scope="col" className="px-6 py-4" key="Actions">Actions</th>
               </tr>
             </thead>
             <tbody>
                {
                    data.map(row => {
                            return (
                            <tr className="border-b border-neutral-200 dark:border-white/10" key={row.id}>
